...
function ForgotPassword() {
  ...
  return (
    <Box sx={{ minHeight: 'auto', display: 'flex', justifyContent: 'center', alignItems: 'center', p: 0 }}>
      <Paper elevation={8}
        sx={{ width: '100%', p: { xs: 3, sm: 4.5 }, borderRadius: '18px', bgcolor: '#0B2045', color: '#F4F7FF', border: '1px solid rgba(99, 148, 240, .40)', boxShadow: '0 24px 70px rgba(0, 5, 28, .45)' }}>
        ...
        {sent ? (
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <Button className="interceptor-loading" fullWidth type="submit" variant="contained" sx={{ mt: 3, py: 1.2, borderRadius: '10px', fontWeight: 800, background: 'linear-gradient(90deg, #7259FF, #397BFF)' }}>Gửi liên kết đặt lại</Button>
